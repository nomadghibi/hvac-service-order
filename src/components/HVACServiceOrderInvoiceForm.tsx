  ...
  return (
    <div className="min-h-screen bg-gray-50 print:bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className={CARD}>
          <h2 className={`${SECTION_TITLE} mb-4`}>Environmental Check List</h2>
        ...
        <div className={CARD}>
          <h2 className={`${SECTION_TITLE} mb-4`}>Work Performed Checklist</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
            {WORK_CATEGORIES.map((cat) => (
              <div key={cat.title} className="border border-gray-200 rounded-lg p-3 bg-gray-50">
                <p className="text-xs font-bold text-blue-600 uppercase tracking-wide pb-2 mb-2 border-b border-blue-100">
                  {cat.title}
                </p>
