...
export default function HVACServiceOrderInvoiceForm({ company }: { company: CompanyConfig }) {
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 pb-24 space-y-4">
        ...
        <div className={CARD}>
          ...
          <div className="sm:hidden space-y-2">
            ...
            <div className="flex justify-between items-center pt-1 px-1 border-t border-blue-200">
              <span className="text-sm font-bold text-blue-700">Total Materials</span>
            ...
            <table className="w-full text-sm min-w-[560px]">
              ...
              <tfoot>
                <tr className="border-t-2 border-blue-200 bg-blue-50">
                  <td colSpan={3} className="px-2 py-2.5 text-right text-sm font-bold text-blue-700">Total Materials</td>
          ...
          <button type="button" onClick={addMaterial} className="no-print mt-3 text-sm text-blue-600 hover:text-blue-800 font-medium">+ Add Row</button>
        </div>
        ...
        <div className={CARD}>
          ...
          <div className="sm:hidden space-y-2">
            ...
            <div className="flex justify-between items-center pt-1 px-1 border-t border-blue-200">
              <span className="text-sm font-bold text-blue-700">Total Labor</span>
          ...
          <div className="hidden sm:block overflow-x-auto">
            <table className="w-full text-sm min-w-[560px]">
              ...
              <tfoot>
                <tr className="border-t-2 border-blue-200 bg-blue-50">
                  <td colSpan={3} className="px-2 py-2.5 text-right text-sm font-bold text-blue-700">Total Labor</td>
          ...
          <button type="button" onClick={addLabor} className="no-print mt-3 text-sm text-blue-600 hover:text-blue-800 font-medium">+ Add Row</button>
        </div>
